// FUTURE Migrate some of the Description (which gets pulled into the IG Artifacts Summary Page) content into elements in the profile
...
BodyStructure.includedStructure.structure shall identify the anatomy associated with the morphologic abnormality identified in .morphology. The code shall be fully pre-coordinated except for the laterality. The code may be very general/high-level if the entity is not precisely localized. 
...
"
// FUTURE migrate identifier constraints and some morphology constraints into FSH 
...
BodyStructure.includedStructure.structure shall identify the anatomy associated with the physical object. The code shall be fully pre-coordinated except for the laterality.  E.g. the coronary artery in which the stent is located. The code may be very general/high-level if the entity is not precisely localized.
