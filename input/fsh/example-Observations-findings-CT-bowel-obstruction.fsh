...
* partOf = Reference(ImagingStudy/example-ImagingStudy-CT-abdomen) // TODO
* status = #final
* category = #imaging
* subject = Reference(Patient/example-Patient)
* encounter = Reference(Encounter/example-Encounter-CT-abdomen) // imaging encounter
* effectiveDateTime = TODO // time of exam
* performer = Reference(Practitioner/example-Practitioner-radiologist) // reporting radiologist
* bodySite = $SCT#122865005 "Gastrointestinal Tract" 
* derivedFrom = Reference(ImagingStudy/example-ImagingStudy-CT-abdomen) //TODO should we also reference the report or is that redundant?
